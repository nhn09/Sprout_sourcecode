...
public class ResearchersLoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_researchers_login_page);
    ...
    public void GoToSignUp(View view){  // goes back to sign Up
        ...
        Intent intent = new Intent(ResearchersLoginPage.this,ResearchersSignUpPage.class);
    ...
    public void signIn(View view)
    {
        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    Toast.makeText(ResearchersLoginPage.this, "Login successful.", Toast.LENGTH_SHORT).show();
                    String userID = String.valueOf(mAuth.getCurrentUser().getUid());


                    Intent intent = new Intent(ResearchersLoginPage.this,ResearchersDashboard.class);
