...
public class q_4 extends AppCompatActivity {

    private String UserId;
    private final String qstnID="q_4";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_k4);
    ...
    public void nextPage(View view)  // triggers when Next button is called
    {
        ...
        Intent intent = new Intent( q_4.this, q_5.class);
